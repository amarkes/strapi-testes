...
`,Cs=({headers:e=[],label:t})=>{const{formatMessage:o}=(0,k.A)();return(0,s.jsxs)(f.s,{children:[(0,s.jsx)(f.s,{width:he,height:ie,shrink:0,alignItems:"center",paddingLeft:6,children:(0,s.jsx)(b.o,{variant:"sigma",textColor:"neutral500",children:o({id:"Settings.roles.form.permission.property-label",defaultMessage:"{label} permissions"},{label:t})})}),e.map(n=>n.isActionRelatedToCurrentProperty?(0,s.jsx)(f.s,{width:H,shrink:0,justifyContent:"center",children:(0,s.jsx)(b.o,{variant:"sigma",textColor:"neutral500",children:o({id:`Settings.roles.form.permissions.${n.label.toLowerCase()}`,defaultMessage:n.label})})},n.label):(0,s.jsx)(f.s,{width:H,shrink:0},n.label))]})},se=e=>(0,S.AH)`
  ${b.o} {
